...
Установка [[https://github.com/jwiegley/use-package][use-package]] для далнейшей настройки =Emacs=.
...
Еще одно удобное [[https://github.com/Alexander-Miller/treemacs/][дерево]], ориентированное на работу с проектами.
...
(use-package aggressive-indent
    :straight t
    :hook (((prog LaTeX) . aggressive-indent-mode)))
#+end_src
