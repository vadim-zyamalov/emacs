...
- [[#настройки-автодополнения][Настройки автодополнения]]
  ...
  - [[#автодополнение-в-минибуфере-vertico-consult-и-embark][Автодополнение в минибуфере: =Vertico=, =Consult= и =Embark=]]
  - [[#сниппеты][Сниппеты]]
...
** Автодополнение в минибуфере: =Vertico=, =Consult= и =Embark=
