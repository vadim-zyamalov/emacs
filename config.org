...
- [[#настройки-автодополнения][Настройки автодополнения]]
  ...
  - [[#vertico-consult-и-embark][=Vertico=, =Consult= и =Embark=]]
  - [[#сниппеты][Сниппеты]]
...
| =C-h F=   | global | helpful-function | Справка по функциям                                 |
...
| Клавиша | Карта  | Команда           | Действие        |
|---------+--------+-------------------+-----------------|
| =C-z=     | global | undo-fu-only-undo | Отмена действий |
| =C-S-z=   | global | undo-fu-only-redo | Повтор действий |
...
| Клавиша | Карта              | Команда                          | Действие                                                                                                             |
|---------+--------------------+----------------------------------+----------------------------------------------------------------------------------------------------------------------|
| =RET=     | company-active-map | my/ret-handle                    | Функция, меняющая поведение в зависимости от состояния: либо стандартное поведение, либо вставка варианта дополнения |
| =TAB=     | company-active-map | company-complete-common-or-cycle | Прокрутка вариантов или вставка единственного из представленных                                                      |
...
| Клавиша | Карта  | Команда         | Действие                                     |
|---------+--------+-----------------+----------------------------------------------|
| =<f2>=    | global | consult-buffer  | Меню выбора буфера                           |
| =C-<f2>=  | global | ibuffer         | "Стандартное" меню выбора буфера             |
