...
|---------+-----------------+----------------------------------------------|
| =<f2>=    | consult-buffer  | Меню выбора буфера                           |
| =C-<f2>=  | ibuffer         | "Стандартное" меню выбора буфера             |
| =C-.=     | embark-act      | Меню выбора действия с объектом под курсором |
| =C-;=     | embark-dwim     | Выполнение стандартного действия с объектом  |
| =C-h B=   | embark-bindings | Меню со справкой по комбинациям клавиш       |
| =C-s=     | consult-line    | Поиск строк по шаблону                       |
|---------+-----------------+----------------------------------------------|
...
| Клавиша | Команда       | Действие                      |
|---------+---------------+-------------------------------|
| =S-TAB=   | tempel-expand | Разворачивание шаблона        |
|         | tempel-done   | Завершение заполнения шаблона |
|---------+---------------+-------------------------------|
| =<f7>=    | tempel-insert | Меню шаблонов                 |
|---------+---------------+-------------------------------|
...
| Клавиша | Команда           | Действие      |
|---------+-------------------+---------------|
| =<f7>=    | consult-yasnippet | Меню шаблонов |
|---------+-------------------+---------------|
