...
Пакет [[https://github.com/Fuco1/smartparens][Smartparens]] автоматически добавляет закрывающие скобки, причем и довольно сложные, такие как скобки LaTeX. Также пакет добавляет функции для смены окружающих скобок и их удаления. Я отказался от использования этого пакета, настройки сохраню на всякий случай.
...
Вместо =Smartparens= перешел на встроенный =Electric-pair=.
